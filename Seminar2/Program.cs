...
namespace Seminar2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            DateTime viitor = DateTime.Now.AddDays(7);     // peste o săptămână
            DateTime trecut = DateTime.Now.AddDays(-1);    // ieri (pentru biletul expirat)
            ...
            while (ruleaza)
            {
                ...
                switch (opt)
                {
                    ...
                    case "4":
                        ...
                        Bilet max = casa.GetBiletCelMaiScump();
